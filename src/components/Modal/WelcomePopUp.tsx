        ...
        <Dialog as="div" className="relative z-10" onClose={closePopUp}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-10 text-center">
              ...
              >
                <Dialog.Panel className="w-full h-80 flex items-center justify-center max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  {/* <Dialog.Title
                    as="h3"
